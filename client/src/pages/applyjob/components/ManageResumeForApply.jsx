    ...
    <div className="flex h-screen">
            ...
            <div className="flex items-center mb-4">
              ...
              <div>
                <h2 className="text-lg font-semibold">
                  {userData.resume.filename?.split("-").slice(1).join("-")}
                </h2>
              ...
              <Icon
                icon={faCheckCircle}
                size="xl"
                className="text-primary-dark ml-auto"
              ></Icon>
            </div>
            <div className="h-60 border border-gray-400 rounded-lg p-4">
              lines
            </div>
      ...
      <div className="flex-[1.2] bg-primary-light/5 p-20 ">
        <div className="p-5 border h-fit rounded-lg bg-white  border-gray-400">
          ...
          <p className="border-b capitalize border-gray-400 pb-4 pt-2 text-sm text-gray-500">
            {companyLocation}
          </p>
          <p className="text-sm leading-relaxed text-gray-500 mt-5 mb-10">
            {jobDescription}
          </p>
