  ...
  return (
    <div className="space-y-4 mt-20">
      ...
      <div className="border-b border-gray-300 pb-5">
        ...
        />
        <JobDetailField
          label="Resume Require?"
          value={formData.resumeRequired ? "Yes" : "No"}
        />
        <JobDetailField
          label="Updates via Email"
          value={formData.individualEmailUpdates ? "Yes" : "No"}
        />
      </div>
      ...
      <p className="text-sm text-gray-800">
        ...
        processed following Indeed's Terms, Cookie, and Privacy Policies.
      </p>
...
function JobDetailField({ label, value }) {
  return (
    <div className="flex justify-between items-center">
      <label className="flex-1 text-gray-700 text-base font-semibold">
        {label}
      </label>
