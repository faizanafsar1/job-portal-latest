...
export default function AddPayAndBenefits({ updateFormData, prevStep, nextStep }) {
  ...
  return (
    <div className="space-y-4 mt-20">
      ...
      <div className="flex w-fit mx-auto flex-wrap gap-4 ">
        <div>
          <label htmlFor="jobtitle" className="text-base font-semibold my-2 w-fit block">
            Minimum <span className="text-red-500">*</span>
          </label>
          <input
            onChange={(e) => setSalaryObj({ ...salaryObj, min: e.target.value })}
            value={salaryObj.min}
            type="number"
            placeholder="Rs"
        ...
        <div>
          ...
          <input
            onChange={(e) => setSalaryObj({ ...salaryObj, max: e.target.value })}
            value={salaryObj.max}
            type="number"
            placeholder="Rs"
            className="max-w-40 p-2 border rounded"
        ...
        <div>
          <label htmlFor="show-pay-by" className="text-base font-semibold my-2 w-fit block">
            Rate <span className="text-red-500">*</span>
          </label>
          <select
            name="rate"
            id="rate"
            onChange={(e) => setSalaryObj({ ...salaryObj, rate: e.target.value })}
