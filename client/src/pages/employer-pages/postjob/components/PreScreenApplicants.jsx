...
export default function PreScreenApplicants({ formData, updateFormData, nextStep, prevStep }) {
  return (
    <div className="space-y-4 mt-20">
      ...
      <div className="p-5 border border-gray-300 rounded-lg">
        <h3 className="text-base font-semibold">Have to have it? Make it a Deal breaker.</h3>
        <p className="text-sm text-gray-500">
          We won’t notify you of candidates that don’t meet your
          <strong> Deal breaker </strong> qualifications. You can review them anytime on your candidate dashboard.
        </p>
      </div>
      <div className="border border-gray-300 rounded-lg">
        <h3 className="p-5 text-base bg-gray-100">
          <strong> Screening question:</strong> Please list 2-3 dates and time ranges that you could do an interview.
        </h3>
      ...
      <select name="jobLocationType" id="jobLocationType" className="w-full p-2 border rounded">
