  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
        ...
        <h1 className="text-2xl font-bold text-center text-gray-800 mb-6">Your Job has been submitted for review!</h1>
        ...
        <div className="mb-6">
          <p className="text-lg font-semibold text-gray-800 mb-2">Keep track of your job listings</p>
          <p className="text-gray-600">
            To keep track of your job listings, go to
            <a href="/my-jobs" className="text-blue-600 hover:text-blue-700 underline">
              My Jobs
            </a>
          </p>
        </div>
        <div className="*:w-full">
          <Button onClick={() => (window.location.href = "/")} label="Return to job search" style="secondary" />
        </div>
