...
export default function AddJobDetails({ formData, updateFormData, prevStep, nextStep }) {
  return (
    <div className="space-y-4 mt-20">
      ...
      <div className="flex flex-wrap gap-4">
        {["Full-time", "Part-time", "Contract", "Temporary", "Internship", "Fresher"].map((job) => (
          <label
            className={`p-2 items-center border  flex gap-2 w-fit rounded-lg ${
              formData.jobType === job ? "bg-primary-light/20 border-primary-light " : "bg-primary-light/5 border-transparent"
            }`}
          >
            <input
              className="size-5"
