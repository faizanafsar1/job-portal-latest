...
export default function AddJobDescription({ formData, updateFormData, nextStep, prevStep }) {
  return (
    <div className="space-y-4 mt-20">
      ...
      <Editor
        ...
        init={{
          ...
          toolbar:
            "undo redo | formatselect | " + "bold italic underline | bullist numlist outdent indent | " + "link | removeformat",
          directionality: "ltr",
